...
[![LICENSE](https://img.shields.io/hexpm/l/pulsar.svg)](https://github.com/jasonahills/pulsar-client-go/blob/master/LICENSE)
...
Check the Projects page at https://github.com/jasonahills/pulsar-client-go/projects for
...
```go
import "github.com/jasonahills/pulsar-client-go/pulsar"
```
